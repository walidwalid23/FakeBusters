...
class NotificationRemoteDataSource extends BaseNotificationRemoteDataSource{
  ...
  @override
  Future<String> deleteUserNotification(String notificationID, String userToken) async{
    try {
      Dio dio = new Dio();
      dio.options.headers['user-token'] = userToken;
      var response =
          await dio.post(ServerManager.baseUrl + "/notifications/deleteNotification", data: {
